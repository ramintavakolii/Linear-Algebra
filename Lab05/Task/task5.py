...
F = F[0:3, 0:3]  # We need to have a square matrix
target_face2 = target_face2[0:3]

print("-----------------------------")
print('F = ', F)
print('target_face2 = ', target_face2)
print("-----------------------------")
print('Shape F = ', F.shape)
print('Shape target_face2 = ', target_face2.shape)

x = np.linalg.solve(F, target_face2)
a, b, c = x
