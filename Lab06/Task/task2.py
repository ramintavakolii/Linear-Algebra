...
for i in range(5):
    ...
    a1,b1,c1 = np.linalg.solve(f,T) # solve 3 random equations
    a2,b2,c2 = np.linalg.lstsq(F,t)[0] # least squares solution
    ...
    print('error_lsq =', np.linalg.norm(Face_lsq - TargetFace))
    print('error_NoisyT =', np.linalg.norm(NoisyTargetFace - TargetFace))
